...
function translatePortuguese() {
  ...
  <div class="whatsapp_widget">
  <div class="whiteButton whatsapp_description">
    <p>Dúvidas? Escreva para nós!<br><span> <a href="mailto:tesorosargentinos@argentina.travel" target="_blank">tesorosargentinos@argentina.travel</a> </span></p>
  </div>
    <!-- <a class="purpleButton whatsapp_button" href="https://api.whatsapp.com/send?phone=5491122403532" target="_blank" rel="noopener noreferrer">
          ...
          <div class="col-12 col-lg-6 offset-xl-1" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-12 order-md-1 whiteButton inscripcion__form-container d-flex align-items-center">
                  <div data-tf-widget="BzHyPnSc" data-tf-inline-on-mobile data-tf-opacity="100" data-tf-iframe-props="title=formularioWeb_POR" data-tf-transitive-search-params data-tf-medium="snippet" style="width:90%;height:300px;margin:2rem auto;"></div><script src="//embed.typeform.com/next/embed.js"></script>            
              </div>
            </div>
